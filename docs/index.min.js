...
addEventListener("t",e,a),removeEventListener("t",e,a)}catch(t){o=!1}function u(t){return t.preventDefault()}var d,f,l,m,v,p=o?{passive:!1}:void 0
...
S/b.width<w/b.height?L=(x=c*S)*b.height/b.width:x=(L=c*w)*b.width/b.height,console.log(x,S,r),x=Math.max(x,S*r),L=Math.max(L,w*r),a.style.width=x+"px",a.style.height=L+"px",A(t,m,v,d,f,x/y,L/E)}}}function g(t,e,n){h(t,C(t,n)*e,n)}function P(t){return-t}return d="data-pan-on-drag",f={button:"left"},addEventListener("mousedown",function(t){if(0===t.button||2===t.button){var e=s(t.target,d),n=e[0],r=e[1]
...
g(n,Math.pow(1+o,-t.deltaY),{origin:t,minScale:+r.minScale||m.minScale,maxScale:+r.maxScale||m.maxScale,scalingProperty:r.scalingProperty||m.scalingProperty}),t.preventDefault()}},p),addEventListener("resize",function(t){for(var e=document.querySelectorAll("["+l+"]"),n=0;n<e.length;n++){var r=e[n]
if(r instanceof HTMLElement){var o=i(r.getAttribute(l))
g(r,1,o)}}}),t.getScale=C,t.pan=c,t.resetScale=function(t,e){h(t,1,e)},t.setScale=h,t.zoom=g,t}({})
