...
s(e,r,o[0],o[1]+t,o[2]+n)}function E(e){return e.preventDefault()}function g(e){return c(e,e.firstElementChild)[0]}function h(e,t,n){var r=(a=t,i=(n=void 0===n?{}:n).minScale||1,l=n.maxScale||10,a<i?i:l<a?l:a),o=n.origin,i=c(e,t=e.firstElementChild),l=i[0],a=i[1],n=i[2]
r!==l&&(i=r/l-1,l=t.getBoundingClientRect(),s(e,t,r,a+i*((o&&o.clientX||0)-l.left),n+i*((o&&o.clientY||0)-l.top)))}function L(e,t,n){h(e,g(e)*t,n)}return m={button:"left"},addEventListener("mousedown",function(e){var t,n,r,o,i,l,a,c
0!==e.button&&2!==e.button||(o=u(e.target,"data-pan-on-drag"),t=o[0],r=o[1],t&&r&&(n=e,o=m,(!r.modifier||n.getModifierState(r.modifier))&&n.button===("right"===(r.button||o.button)?2:0))&&(e.preventDefault(),i=e.clientX,l=e.clientY,a=function(e){p(t,i-e.clientX,l-e.clientY),i=e.clientX,l=e.clientY,e.preventDefault()},c=function(){removeEventListener("mouseup",c),removeEventListener("mousemove",a),removeEventListener("contextmenu",E)},addEventListener("mouseup",c),addEventListener("mousemove",a),addEventListener("contextmenu",E)))}),f="data-zoom-on-wheel",(d=void 0===d?{}:d).noEmitStyle||((document.head||document.body||document.documentElement).appendChild(document.createElement("style")).textContent="["+f+"]{overflow:scroll}["+f+"]>:first-child{width:100%;height:100%;vertical-align:middle;transform-origin:0 0}"),addEventListener("wheel",function(e){var t=u(e.target,f),n=t[0],r=t[1]
...
r instanceof HTMLElement&&(n=i(r.getAttribute(f)),L(r,1,n))}}),e.getScale=g,e.pan=p,e.resetScale=function(e){var t=e.firstElementChild
t.style.margin=e.scrollLeft=e.scrollTop=0,t.removeAttribute("transform"),t.style.transform=""},e.setScale=h,e.zoom=L,Object.defineProperty(e,"__esModule",{value:!0}),e}({})
