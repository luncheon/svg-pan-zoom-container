...
export const getScaleAndOffset = (container, content) => {
...
export const setScaleAndOffset = (container, content, scale, offsetX, offsetY) => {
...
export const findTargetAndParseOptions = (element, attributeName) => {
